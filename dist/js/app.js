(() => {
  ...
  function n() {
    ...
    t &&
      t.addEventListener("click", function (t) {
        e && (s(), document.documentElement.classList.toggle("open"));
      });
  }
  function r(t) {
    setTimeout(() => {
  ...
  window.addEventListener("scroll", () => {
    ...
    t <= 0
      ...
      : (t > p && !c.classList.contains(u)
          ? (c.classList.remove(h), c.classList.add(u))
          : t < p &&
            c.classList.contains(u) &&
            (c.classList.remove(u), c.classList.add(h)),
        (p = t));
  });
})();
